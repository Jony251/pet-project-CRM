...
import { invoices as allInvoices } from '../../api/mock/data';
...
export default function Invoices() {
  ...
  const { data: result, loading } = useFetch(
    () => fetchPaginated(allInvoices, { page: page + 1, pageSize: 10, search, filter: { status: statusFilter } }),
          ...
          <>
            <TableContainer>
              <Table aria-label="invoices table">
                <TableHead>
                  <TableRow><TableCell>Invoice</TableCell><TableCell>Customer</TableCell><TableCell>Date</TableCell><TableCell>Due Date</TableCell><TableCell align="right">Amount</TableCell><TableCell align="center">Status</TableCell></TableRow>
                </TableHead>
                <TableBody>
                  {data.map((inv) => (
